...
- [ ] Verify licences for native libraries and release assets; retain Minecraft-derived artwork only for the reviewed target version
  ...
  - [ ] Runtime illustration migration: 37 diagrams (28 crafting, 4 brewing, 5 multi-panel) render from installed assets and exclude their PNGs; batches 1–6 accepted, four-panel armour visuals pending in `LiveIllustrations.md`
