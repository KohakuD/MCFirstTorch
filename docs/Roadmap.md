...
- [ ] Verify licences for native libraries and release assets; retain Minecraft-derived artwork only for the reviewed target version
  ...
  - [ ] Runtime illustration migration: 26 diagrams (22 crafting, 4 brewing) render from installed assets and exclude their PNGs; batches 1/2 accepted, brewing visuals pending in `LiveIllustrations.md`
