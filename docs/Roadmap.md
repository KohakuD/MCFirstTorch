...
- [ ] Verify licences for native libraries and release assets; retain Minecraft-derived artwork only for the reviewed target version
  ...
  - [ ] Runtime illustration migration: 36 diagrams (28 crafting, 4 brewing, 4 paired) render from installed assets and exclude their PNGs; batches 1–5 accepted, counted-shapeless visuals pending in `LiveIllustrations.md`
