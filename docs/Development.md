...
First Torch is a native NeoForge mod. The active target is Minecraft Java `26.1.2`, NeoForge `26.1.2.84`, Java `25`, and First Torch `0.13.0-alpha.1`.
...
pwsh .\tools\verify-native-jar.ps1 -JarPath .\build\libs\firsttorch-0.13.0-alpha.1.jar
```
