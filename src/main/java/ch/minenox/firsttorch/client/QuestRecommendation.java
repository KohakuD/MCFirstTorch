...
final class QuestRecommendation {
    ...
    static GuideBrowserViewModel.Selection choose(GuideSnapshot snapshot, ProgressPayload progress) {
        ...
        if (guide.id().equals(COURSE) && byId.containsKey(COURSE_GOAL)) {
            ...
            if (byId.containsKey("3E4D819BA0DFF522")) pending.add("3E4D819BA0DFF522");
            if (byId.containsKey("3C3122DF5C0EA192")) pending.add("3C3122DF5C0EA192"); // The final reference cards remain optional reading.
            if (byId.containsKey("7AC2CFDD99167DA0")) pending.add("7AC2CFDD99167DA0"); // Recovering the Elytra never requires the optional Egg.
            if (byId.containsKey("213E895B26A0F5B5")) pending.add("213E895B26A0F5B5"); // Outer-island travel remains independent of optional Egg retrieval.
