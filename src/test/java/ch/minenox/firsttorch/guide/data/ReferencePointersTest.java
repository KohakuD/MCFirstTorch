...
final class ReferencePointersTest {
    ...
    private static final Set<String> CHAPTER_KEYS = Set.of("field_copper", "field_travel", "field_plants", "field_animals", "field_overworld", "field_nether",
            ...
            "mechanics_curing", "mechanics_cauldrons", "mechanics_pumpkins", "mechanics_trials", "mechanics_tiny", "mechanics_anchor");
