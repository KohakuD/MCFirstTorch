...
This document preserves the FTB-based pack workflow. It does not install or update the independent native mod; see the repository README for that path. Native progress migration is not provided by these scripts.
...
- Current milestone: native 0.13.0-alpha.1; Redstone and optional reference content implemented, with remaining verification tracked in [docs/ReferenceVerification.md](ReferenceVerification.md)
