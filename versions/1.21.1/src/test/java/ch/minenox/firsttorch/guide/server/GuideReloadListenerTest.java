...
final class GuideReloadListenerTest {
    ...
    @Test void invalidAndUnreadableResourcesLeaveLastPublishedSnapshotIntact() {
        ...
        try {
            var good = manager(Map.of(ResourceLocation.parse("firsttorch:guides/good.json"), resource(VALID)));
            ...
            for (Resource broken : new Resource[]{resource("{broken"), new Resource(null, () -> {
                ...
                var bad = manager(Map.of(
                        ResourceLocation.parse("firsttorch:guides/good.json"), resource(VALID),
                        ResourceLocation.parse("firsttorch:guides/bad.json"), broken));
    ...
    private static ResourceManager manager(Map<ResourceLocation, Resource> resources) {
